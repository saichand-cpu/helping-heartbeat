      ...
      <div className="rounded-3xl bg-card border border-border p-5 md:p-6 shadow-pop">
        <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5 sm:gap-8">
          <div className="relative group shrink-0">
            <div className="h-24 w-24 md:h-28 md:w-28 rounded-full overflow-hidden bg-gradient-to-br from-primary to-primary grid place-items-center text-white text-3xl font-bold ring-2 ring-[hsl(45_90%_55%)]/50">
              {profile.avatar_url ? (
            ...
            <div className="grid grid-cols-3 gap-2 mt-4 max-w-md">
              {[
                ...
                <div key={s.l} className="text-center">
                  ...
                  <div className="text-[10px] uppercase tracking-[0.15em] text-amber-500 mt-0.5 font-semibold">{s.l}</div>
                </div>
              ))}
            </div>
